...
{		
		mata {
			mCR = st_data(., "CR_L1 CR_L2 CR_L3 CR_L4 CR_L5 CR_L6 CR_L7 CR_L8 CR_L9")		
			rmCR = J(rows(mCR), 2, "")
...
{		
		mata {
			mCD = st_data(., "CD_L1 CD_L2 CD_L3 CD_L4 CD_L5 CD_L6 CD_L7 CD_L8 CD_L9")		
			rmCD = J(rows(mCD), 2, "")
...
{		
		mata {
			mCI = st_data(., "CI_L1 CI_L2 CI_L3 CI_L4 CI_L5 CI_L6 CI_L7 CI_L8 CI_L9")		
			rmCI = J(rows(mCI), 2, "")
