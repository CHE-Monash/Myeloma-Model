...
**********
	...
	*Create nL5 and update nL
		mata: st_matrix("stL5_CR", oL5_CR)
		scalar nL5 = colsof(stL5_CR)
		scalar nL = nL + nL4

	*Calculate outcome for nL5 == 4
		if nL5 == 4 {
			forvalues i=1(1)`=Obs'{
				*Set e(XB1) to 1
					mata: `=m'[`i',`=c'XB1] = 1	
