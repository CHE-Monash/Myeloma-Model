...
* Transport VRd - Predicted Cohort Generation
*
* Purpose: Predicted Cohort Generation
*          Identifies all patients starting L1 during 2020-2025
*
* Inputs:  patients/population_1995_2040_[1-10].dta
* Outputs: analyses/$analysis/patients/predicted_cohort.dta
*
* Author: Adam Irving
* Date: June 2026
**********
...
forval s = 1/`n_samples' {
	...
	global int			"vrd"            	// Intervention
	global line         "1"             	// Line being assessed
	global coeffs		"vrd_post"    		// Which coefficients
	global data		    "population_`s'"	// Which patients (independent sample s: population_1995_2040_`s')
	global min_year		"2015"				// Patients diagnosed from
	global max_year		"2030"				// Patients diagnosed until
