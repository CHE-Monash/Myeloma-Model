...
* Usage:   do "analyses/default/plot_os_curve.do" [csv]   (default csv: analyses/default/results/os_wholepop_curve_validation.csv)
**********
...
local csv `"`1'"'
if `"`csv'"' == "" local csv "analyses/default/results/os_wholepop_curve_validation.csv"
capture confirm file "`csv'"
if _rc {
    di as error "Validation CSV not found: `csv'"
    di as error "Run analyses/default/bootstrap_validation.do first (it writes os_wholepop_curve_validation.csv), then pull it back."
    exit 601
}
...
graph export "analyses/default/results/os_wholepop_curve.png", replace width(1800)
graph save   "analyses/default/results/os_wholepop_curve.gph", replace
di as text "Wrote analyses/default/results/os_wholepop_curve.png (+ .gph)"
