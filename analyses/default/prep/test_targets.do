...
*          analyses/default/targets/ (13 csv files).
**********
...
capture mkdir "analyses/default/targets"
...
if _rc {
	...
	di as error "Run analyses/default/run.do step 1 (multiple_imputation ... test) first."
	exit 601
}

di as text "Building OOS targets from `testdata' ..."
do "prep/generate_benchmarks.do" "`testdata'" "analyses/default/targets"
di as text "OOS targets written to analyses/default/targets/"
