...
cap cd "~/em76_scratch2/adam/analyses/transport_dvd"
...
file write `fr' "Bootstrap mean with 95% percentile CI (500 iterations; A and B bootstrapped). MAE is vs the raw observed DVd distribution (n=533, fixed); C_mrdr is retained for the BCR table and economics. Generated by bootstrap_summary.do." _n _n
