...
*          re-simulating:
*            - ce_convergence.do  : samples sizes from the pool for the CE sweep
*            - generate_bi_cohort : the BI cohort is the pool as-is (the real count)
*            - transport_dvd.do   : production runs read a drawn cohort
*
...
local all_l2     = 1           // 1 = ALL L2-reachers (large DISTINCT pool for the sample-size study)
