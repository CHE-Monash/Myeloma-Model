...
global analysis     "dvd_method"    	// Analysis name
...
global scenario     "C_mrdr"     		// Scenario (A_trial / B_transport / C_mrdr)
...
qui if ($boot == 1) {
	...
	mata: mata clear 
        ...
        // Save results
        save "$simulated_path/bootstrap/$scenario/$int_$line_$data_${min_id}_${max_id}_B`b'.dta", replace
    }
}
