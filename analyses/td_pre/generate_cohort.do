...
forval s = 1/`n_samples' {
	...
	global int			"td"         		// Intervention
	global line         "4"             	// Line being assessed
	global coeffs		"td_pre"    		// Which coefficientsr
	global data		    "population"    	// Which patients
	global min_year		"1995"				// Patients diagnosed from
	global max_year		"2026"				// Patients diagnosed until
	...
	replace TXR_L${line} = .
    replace ID = _n
	replace DateDN = td(1jan${cost_year}) - (TSD_L${line}S * 30.4375)
