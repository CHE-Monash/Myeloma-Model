	...
	*Determine outcome
		forvalues i = 1/`=Obs'{
			*Calculate xb
				...
				*BCR_L1 - Uses mBCR rather than `=m' because `=m' includes either BCR_L1 or BCR_SCT depending on whether SCT = 1 or 0
					mata {
						if		(mBCR[`i',2] == 2) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,10 + cols(`=o')] 
						else if	(mBCR[`i',2] == 3) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,11 + cols(`=o')] 
						else if	(mBCR[`i',2] == 4) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,12 + cols(`=o')]
						else if	(mBCR[`i',2] == 5) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,13 + cols(`=o')] 
						else if	(mBCR[`i',2] == 6) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,14 + cols(`=o')] 
					}
				*BCR_SCT - Uses `=m' because BCR_SCT is not in mBCR
					mata {
						if		(`=m'[`i',cSCT] == 1 & `=m'[`i',cBCR] == 1) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,16 + cols(`=o')] 
						else if	(`=m'[`i',cSCT] == 1 & `=m'[`i',cBCR] == 2) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,17 + cols(`=o')] 
						else if	(`=m'[`i',cSCT] == 1 & `=m'[`i',cBCR] == 3) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,18 + cols(`=o')] 
						else if	(`=m'[`i',cSCT] == 1 & `=m'[`i',cBCR] == 4) `=m'[`i',`=c'XB] = `=m'[`i',`=c'XB] + `=b'[1,19 + cols(`=o')]
					}
			
			*Probabilities
				mata: `=m'[`i',`=c'PR1] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,20 + cols(`=o')]))
				mata: `=m'[`i',`=c'PR2] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,21 + cols(`=o')]))
				mata: `=m'[`i',`=c'PR3] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,22 + cols(`=o')]))
				mata: `=m'[`i',`=c'PR4] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,23 + cols(`=o')]))
				mata: `=m'[`i',`=c'PR5] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,24 + cols(`=o')]))
				mata {
