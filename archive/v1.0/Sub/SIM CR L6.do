...
**********
	...
	*Create nL6 and update nL
		mata: st_matrix("stL6_CR", oL6_CR)
		scalar nL6 = colsof(stL6_CR)
		scalar nL = nL + nL5

	*Calculate outcome for nL6 == 4
		if nL6 == 4 {
			forvalues i=1/`=Obs'{
				*Set e(XB1) to 1
					mata: `=m'[`i',`=c'XB1] = 1	
				...
				*Calculate e(XB2)
					...
					*ISS 
						mata {
							if 		(`=m'[`i',cISS] == 2) `=m'[`i',`=c'XB2] = `=m'[`i',`=c'XB2] + `=b'[1,18+`=nL'] 
							else if (`=m'[`i',cISS] == 3) `=m'[`i',`=c'XB2] = `=m'[`i',`=c'XB2] + `=b'[1,19+`=nL']
						}
					*CR_L1
						forvalues j = 1/`=nL1'{
							mata {
					...
					*CR_L3
						forvalues j = 1/`=nL3'{
							mata {
								if	(mCR[`i',4] == oL3_CR[1,`j']) `=m'[`i',`=c'XB2] = `=m'[`i',`=c'XB2] + `=b'[1,19+`=nL'+`j'+`=nL1'+`=nL2']
							}
						}
					*CR_L4
						forvalues j = 1/`=nL4'{
							mata {
								if	(mCR[`i',5] == oL4_CR[1,`j']) `=m'[`i',`=c'XB2] = `=m'[`i',`=c'XB2] + `=b'[1,19+`=nL'+`j'+`=nL1'+`=nL2'+`=nL3']
							}
						}
					*CR_L5
						forvalues j = 1/`=nL5'{
							mata {
								if	(mCR[`i',6] == oL5_CR[1,`j']) `=m'[`i',`=c'XB2] = `=m'[`i',`=c'XB2] + `=b'[1,19+`=nL'+`j'+`=nL1'+`=nL2'+`=nL3'+`=nL4']
							}
						}		
					*cons
				...
				*Calculate e(XB3)
					...
					*CR_L3
						forvalues j = 1/`=nL3'{
							mata {
								if	(mCR[`i',4] == oL3_CR[1,`j']) `=m'[`i',`=c'XB3] = `=m'[`i',`=c'XB3] + `=b'[1,29+(`=nL')*2+`j'+`=nL1'+`=nL2']
							}
						}
					*CR_L4
						forvalues j = 1/`=nL4'{
							mata {
								if	(mCR[`i',5] == oL4_CR[1,`j']) `=m'[`i',`=c'XB3] = `=m'[`i',`=c'XB3] + `=b'[1,29+(`=nL')*2+`j'+`=nL1'+`=nL2'+`=nL3']
							}
						}
					*CR_L5
						forvalues j = 1/`=nL5'{
							mata {
								if	(mCR[`i',6] == oL5_CR[1,`j']) `=m'[`i',`=c'XB3] = `=m'[`i',`=c'XB3] + `=b'[1,29+(`=nL')*2+`j'+`=nL1'+`=nL2'+`=nL3'+`=nL4']
							}
						}			
					*cons
				...
				*Calculate e(XB4)
					...
					*CR_L3
						forvalues j = 1/`=nL3'{
							mata {
								if	(mCR[`i',4] == oL3_CR[1,`j']) `=m'[`i',`=c'XB4] = `=m'[`i',`=c'XB4] + `=b'[1,39+(`=nL')*3+`j'+`=nL1'+`=nL2']
							}
						}
					*CR_L4
						forvalues j = 1/`=nL4'{
							mata {
								if	(mCR[`i',5] == oL4_CR[1,`j']) `=m'[`i',`=c'XB4] = `=m'[`i',`=c'XB4] + `=b'[1,39+(`=nL')*3+`j'+`=nL1'+`=nL2'+`=nL3']
							}
						}
					*CR_L5
						forvalues j = 1/`=nL5'{
							mata {
								if	(mCR[`i',6] == oL5_CR[1,`j']) `=m'[`i',`=c'XB4] = `=m'[`i',`=c'XB4] + `=b'[1,39+(`=nL')*3+`j'+`=nL1'+`=nL2'+`=nL3'+`=nL4']
							}
						}			
					*cons
