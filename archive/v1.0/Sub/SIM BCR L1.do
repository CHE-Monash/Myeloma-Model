...
**********
	...
	*Determine outcome
		forvalues i = 1/`=Obs'{
			...
			*Probabilities
					mata: `=m'[`i',`=c'PR1] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,9 + cols(`=o')]))
					mata: `=m'[`i',`=c'PR2] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,10 + cols(`=o')]))
					mata: `=m'[`i',`=c'PR3] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,11 + cols(`=o')]))
					mata: `=m'[`i',`=c'PR4] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,12 + cols(`=o')]))
					mata: `=m'[`i',`=c'PR5] = 1/(1+exp(`=m'[`i',`=c'XB] - `=b'[1,13 + cols(`=o')]))
					mata {
